...
!(function () {
  ...
  var e = {
    ...
    RESULTS: { BASE: "autocomplete__results", VISIBLE: "autocomplete__results--is-visible" },
    RESULT: { BASE: "autocomplete__result", SELECTED: "autocomplete__result--is-selected" },
    NOTICE: "autocomplete__notice",
    SELECT_RESULT: "autocomplete__select-result",
    LIST: "autocomplete__list",
  },
    s = { ENTER: 13, ESC: 27, UP: 38, DOWN: 40 },
    i = (function () {
      function t(s) {
        var i = this;
        _classCallCheck(this, t),
          ...
          this.container.classList.add(e.CONTAINER),
          (this.container.style.position = "relative"),
          (this.label = this.container.querySelector("label"));
        var n = [].slice.call(s.querySelectorAll("option")),
          u = this.select.id + "-autocomplete";
        (this.isVisible = !1),
          (this.options = n.map(function (t, e) {
            return { label: t.textContent, value: t.value, id: i.select.id + "-autocomplete-result-" + e };
          })),
          this.outputInput(u),
          this.outputResultsList(u),
          this.outputResultsNotice(u),
        ...
        _createClass(t, [
          ...
          },
          {
            ...
            value: function () {
              ...
              this.results.length > 0
                ? this.results.forEach(function (s) {
                  var i = document.createElement("li");
                  i.setAttribute("id", s.id),
                    i.classList.add(e.RESULT.BASE),
                    (i.textContent = s.label),
                    (i.dataset.value = s.value),
                ...
                : !(function () {
                  ...
                  s.classList.add(e.RESULT.BASE),
                    (s.textContent = "No results found"),
                    window.requestAnimationFrame(function () {
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.isVisible = !0),
                window.requestAnimationFrame(function () {
                  t.resultsList.classList.add(e.RESULTS.VISIBLE),
                    t.input.setAttribute("aria-expanded", "true"),
                    0 === t.results.length
                      ? (t.resultsNotice.textContent = "No results found")
                      : 1 === t.results.length
                        ? (t.resultsNotice.textContent = "1 result")
                        : (t.resultsNotice.textContent = t.results.length + " results");
                });
            },
          },
          {
            ...
            value: function (t) {
              ...
              (this.input = document.createElement("input")),
                ...
                this.input.setAttribute("aria-owns", t),
                this.input.classList.add(e.INPUT),
                this.input.id =  e.INPUT,
                window.requestAnimationFrame(function () {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (this.resultsList = document.createElement("ul")),
                this.resultsList.classList.add(e.RESULTS.BASE),
                this.resultsList.setAttribute("id", t),
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.resultsNotice = document.createElement("div")),
                this.resultsNotice.classList.add(e.NOTICE),
